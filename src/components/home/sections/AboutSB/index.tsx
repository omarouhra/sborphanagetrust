    ...
    <Wrapper>
      <div className="mb-16 flex flex-col lg:flex-row lg:items-center lg:justify-between lg:space-x-7">
        ...
        <div className="relative order-first md:my-12 lg:order-last">
          ...
          <div className="absolute -right-3 -top-8 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-green-g1 to-green-g3 text-white md:-top-28 md:right-14 md:h-24 md:w-24 lg:-right-0 lg:-top-16 xl:-right-8 xl:-top-10">
