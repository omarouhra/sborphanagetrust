      ...
      <Wrapper>
        <div className="mb-16 flex flex-col space-y-6 md:space-y-10 lg:flex-row lg:items-start lg:justify-between lg:space-x-10 lg:space-y-0">
          <div className="relative mt-3">
            <div className="hidden rounded-2xl border-2 border-green-1/50 lg:flex lg:ml-0 lg:h-[681px] lg:w-[545px]" />
        ...
        <GradientContainer className="md:py-24">
          <div className="w-full md:max-w-[980px]">
            ...
            <p className="flex w-full justify-end text-justify text-sm font-medium uppercase px-1	tracking-wide md:text-base md:leading-normal">
              - Mufti Ahsan Ahmed
            </p>
          </div>
        </GradientContainer>
