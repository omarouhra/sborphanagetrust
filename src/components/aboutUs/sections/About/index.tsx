...
export default function About() {
  return (
    <Wrapper>
      <div className="mb-16 flex flex-col space-y-96  md:space-y-10 lg:flex-row lg:items-start lg:justify-between lg:space-x-7 lg:space-y-0">
        <div className="relative mt-3">
          <div className="hidden h-[430px] w-[490px] rounded-2xl border-2  border-green-1/50 md:ml-20 md:flex  lg:ml-0 lg:h-[570px] lg:w-[480px]" />
          <div className="absolute z-30 mb-8 flex h-[430px] w-[490px] justify-end md:absolute md:-bottom-16 md:left-28 md:mb-20 lg:-right-0 lg:bottom-3  lg:left-4 lg:mb-0 lg:h-[570px] lg:w-[480px]">
            <CustomImage
              src={AhsanAhmad}
              alt="ahmad-ahsann"
              priority
        ...
        <div className="flex w-full flex-col space-y-5 text-dark-1  lg:max-w-[560px]">
          <Paragraph
      ...
      <GradientContainer>
        <div className="w-full md:max-w-[980px]">
          <p className="mb-6 text-center text-3xl font-medium text-white md:leading-10">
          ...
          <p className="flex w-full justify-end text-base font-medium	uppercase tracking-wide md:leading-normal">
            - Mufti Ahsan Ahmed
          </p>
        </div>
      </GradientContainer>
